            ...
            <main className="container-main">
                ...
                <section className="cadastrar-consulta">
                    ...
                    <form onSubmit={cadastrarConsultas} className="container-cadastrar-consulta">
                        ...
                        <select className="input-cadastro" name="paciente" id="paciente" value={idPaciente} defaultValue="0" onChange={(campo) => setIdPaciente(campo.target.value)}>
                        ...
                        <select class="input-cadastro" name="medico" id="medico"  value={idMedico} defaultValue={0} onChange={(campo) => setIdMedico(campo.target.value)}>
